...
RUN apk add git nginx php84-cli php84-fpm php84-fileinfo php84-ctype supervisor \
 ...
 && echo -e "#!/bin/sh\n/usr/bin/php84 /srv/single_php_filehost/index.php purge" > /etc/periodic/daily/purge && chmod u+x /etc/periodic/daily/purge\
 && chmod u+x /entry.sh \
